...
/**
 * Tests DMITest. Run from the command line with:<p>
 * java weka.filters.unsupervised.attribute.DMITest
 *
 * @author Amri Napolitano
 * @version $Revision: 8108 $
 */
public class DMITest extends AbstractFilterTest {
  
  public DMITest(String name) { super(name);  }

  /** Creates a default DMITest */
  ...
  public static Test suite() {
    return new TestSuite(DMITest.class);
  }
